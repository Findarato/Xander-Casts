...
with open("podcasts.txt") as podcasts:
    for line in podcasts:
        Xander_podcasts[int(counter)] = dict( content_type="audio/mp3", url=line)
        counter = counter + 1

# Lets just make sure He has the princess and the dragon
podcasts_to_play[0] = dict( content_type="audio/mp3", url="https://chtbl.com/track/11GGG/media.blubrry.com/storytime/media.bedtime.fm/story-time_90.mp3")
